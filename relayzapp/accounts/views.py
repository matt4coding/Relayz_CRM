...
from relayzapp.contacts.models import Contact
from relayzapp.communications.models import Communication
from relayzapp.communications.forms import CommunicationForm
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            redirect_url = reverse(
                'relayzapp.accounts.views.account_detail',
                args=(account.uuid,)
            )
