...
urlpatterns = patterns('',
    ...
    url(r'^signup/$',
        'relayzapp.subscribers.views.subscriber_new', name='sub_new'
    ),
    ...
    url(r'^account/new/$',
        'relayzapp.accounts.views.account_cru', name='account_new'
    ),
    url(r'^account/list/$',
    ...
    url(r'^contact/new/$',
        'relayzapp.contacts.views.contact_cru', name='contact_new'
    ),
    url(r'^contact/(?P<uuid>[\w-]+)/', include(contact_urls)),

    # Communication related URLs
    url(r'^comm/new/$',
        'relayzapp.communications.views.comm_cru', name='comm_new'
    ),
